...
c.MarkdownExporter.template_path = ['D:/Anaconda3/Lib/site-packages/nbconvert/templates'] # point this to your jekyll template file
...
def path2support(path):
    ...
    return '/assets/notebooks/' + os.path.basename(path)
